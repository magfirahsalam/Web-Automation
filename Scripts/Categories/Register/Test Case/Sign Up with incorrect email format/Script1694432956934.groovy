...
WebUI.callTestCase(findTestCase('Register/Step Definition/02 User input email with all numbers contain'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Register/Step Definition/03 user click input password'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Register/Step Definition/04 user click daftar with close browser'), [:], FailureHandling.STOP_ON_FAILURE)
